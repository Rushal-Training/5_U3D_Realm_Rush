...
{
    //https://community.gamedev.tv/t/changed-to-dijkstra-pathfinding/63572/2

    public Waypoint startWaypoint, endWaypoint;
    Dictionary<Vector2Int, Waypoint> grid = new Dictionary<Vector2Int, Waypoint>();
    SortedDictionary<int, Waypoint> sortedQueue = new SortedDictionary<int, Waypoint>(); // We use a SortedDictionary instead of a Queue
    ...
    public List<Waypoint> GetPath(Waypoint start, Waypoint end)  // I added the start and end waypoint here so you can send them from another script
    {
